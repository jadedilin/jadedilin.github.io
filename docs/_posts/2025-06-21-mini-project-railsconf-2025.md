...
This article was written about non-traditional paths into Ruby on Rails development. It was written for the [Scholars and Guides](https://rubycentral.org/scholars_guides_program/) program of RailsConf 2025 in Philadelphia.
...
Seeking a community that aligned with my journey, I joined [WNB.rb](http://WNB.rb), an incredibly supportive community for women and nonbinary Rubyists. Through WNB.rb, I discovered Ruby Central’s Scholars and Guides program. Participating in this initiative not only strengthened my coding foundations but also connected me deeply with the Ruby community, inspiring me to take on more projects and further my development skills.
...
The program is specifically designed so that people with less experience in software can easily access advice regarding learning, career development, and the conference. My guide Michelle was therefore my first point of contact. I also reached out to [Felipe Vogel](https://fpsvogel.com/) for advice to first-time conference goers, who said:
...
### Community resources  
- [Scholars and Guides](https://rubycentral.org/scholars_guides_program/)  
- [WNB.rb](http://WNB.rb)  
- [First Ruby Friend](https://firstrubyfriend.org/)  
- [Rubyevents.org](http://rubyevents.org)  
